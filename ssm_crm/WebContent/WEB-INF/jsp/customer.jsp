...
<%@ taglib prefix="ckz" uri="http://ckz.com/common/"%> 
...
<body>
	...
	<div id="wrapper">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="index.html">ckz客户管理系统 v2.0</a>
		</div>
		<!-- /.navbar-header -->
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="col-md-12 text-right">
							<ckz:page url="${pageContext.request.contextPath }/customer/list.action" />
						</div>
						<!-- /.panel-body -->
					</div>
					<!-- /.panel -->
	...
	<script type="text/javascript">
		function editCustomer(id) {
			$.ajax({
				type:"get",
				url:"<%=basePath%>customer/editCustomer.action",
				data:{"id":id},
